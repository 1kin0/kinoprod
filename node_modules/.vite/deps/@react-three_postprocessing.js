...
var P = (e, t) => function({ blendFunction: o = t?.blendFunction, opacity: r = t?.opacity, ...a }) {
  let n = le.get(e);
  if (!n) {
...
var ht = (0, import_react.forwardRef)(({ target: e = void 0, mouse: t = false, debug: o = void 0, manual: r = false, smoothTime: a = 0.25, ...n }, i) => {
  ...
  useFrame(async (b, F) => {
    r || c(F), l.current && l.current.position.copy(x), p2.current && s.current?.target && p2.current.position.copy(s.current.target);
  });
